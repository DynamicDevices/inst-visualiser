...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initialising UWB Position Visualiser v3.3 - INST Crisis Response...');
    ...
    window.debugVisualizer = function() {
        console.log('=== UWB Position Visualiser v3.3 Emergency Debug Info ===');
        ...
        console.log('INST emergency network status:', visualizer ? (visualizer.mqttConnected ? 'Connected' : 'Disconnected') : 'Unknown');
    ...
    window.crisisUtils = {
        ...
        connectToINST: () => visualizer?.connectMQTT(),
        disconnectFromINST: () => visualizer?.disconnectMQTT(),
        getCasualtyStats: () => ({
            ...
            instConnected: visualizer?.mqttConnected || false,
        ...
        getCrisisStatus: () => ({
            ...
            networkStatus: visualizer?.mqttConnected ? 'INST Connected' : 'INST Disconnected',
    ...
    console.log('UWB Position Visualiser v3.3 ready for crisis operations!');
