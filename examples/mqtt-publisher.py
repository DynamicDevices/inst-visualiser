#!/usr/bin/env python3
"""
MQTT Publisher Example for INST Tag Visualizer
Publishes sample UWB positioning data to MQTT broker

Usage:
    python mqtt-publisher.py --broker mqtt.example.com --topic uwb/positioning
    python mqtt-publisher.py --simulate  # Use built-in simulation data
"""
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='MQTT Publisher for INST Tag Visualizer')
